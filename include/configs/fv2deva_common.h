...
#ifndef __FV2DEVA_COMMON_CONFIG_H
#define __FV2DEVA_COMMON_CONFIG_H
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"netboot=echo Booting from net ...; " \
		...
		"findfdt="\
			"if test $fdt_file = undefined; then " \
				"if test $board_name = FV2DEVA && test $board_rev = MX6Q; then " \
					"setenv fdt_file fv2q-dev-a.dtb; fi; " \
				"if test $board_name = SABREAUTO && test $board_rev = MX6QP; then " \
					"setenv fdt_file imx6qp-sabreauto.dtb; fi; " \
				"if test $board_name = SABREAUTO && test $board_rev = MX6Q; then " \
					"setenv fdt_file imx6q-sabreauto.dtb; fi; " \
...
#endif                         /* __FV2DEVA_COMMON_CONFIG_H */
